...
-- -----------------------------------------------------
-- Table `libreria_buscalibre`.`cliente_Libro`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `libreria_buscalibre`.`cliente_Libro` (
  `id_cliente` VARCHAR(10) NOT NULL,
  `Libro_ISBN` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `libreria_buscalibre`.`telefono_cliente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `libreria_buscalibre`.`telefono_cliente` (
  `telefono` VARCHAR(25) NOT NULL,
  `cliente_id_cliente` VARCHAR(10) NOT NULL,
  PRIMARY KEY (`telefono`, `cliente_id_cliente`),
